import { authRepository } from '../repository/authUsuario.repository';
import { AUTH_TOKEN_STORAGE_KEY } from '../../../core/constants/auth.storage';
import type { LoginRequest, AuthUser, JwtPayload } from '../dto/authUsuario.dto';
import { decodeJwtPayload } from '@/features/authEstudiantes/utils/jwt';

export const authUsuarioService = {
